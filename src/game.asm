...
.proc update_ball
  ...
  ; now move our ball
	...
	adc ball_dy ; add the Y velocity
 	...
 	cmp #$00 ; have we hit the top border
 	bne NOT_HITTOP
...
NOT_HITTOP:
 	lda ball_y
 	cmp #$E8 ; have we hit the bottom border
...
NOT_HITLEFT:
 	lda ball_x
 	cmp #$F8 ; have we hit the right border
...
; Load palette data
palette_data:
  .incbin "assets/palettes/game.pal"
; Load nametable data
nametable_data:
  .incbin "assets/screens/game.nam"
